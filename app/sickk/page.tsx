...
export default function SyncPage() {
  ...
  const handleSearch = (filters: SearchFilters) => {
    if (filters.provider.toLowerCase() === 'sync.top' || filters.game.toLowerCase() === 'fortnite') {
      setSearchResults({ provider: 'Sync.top', game: 'FORTNITE' })
    } else {
    ...
    <section className="flex flex-col items-center justify-center p-2 my-4 mt-8 mb-2 space-y-4 font-bold text-md md:text-md">
      <div className="flex items-center justify-center space-x-4">
        <Image 
          ...
          src="/assets/sickk.webp" 
          alt=""
          width={56}
          height={56}
        />
        <span className="flex items-center justify-center capitalize">
          <span className="text-xl font-bold md:text-2xl">Sickk Services</span>
        </span>
      </div>
      
      <div className="flex flex-wrap items-center justify-center space-x-2">
        <Link href="https://www.sickkservices.net/" target="_blank" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-gray-300 rounded border border-gray-600 transition duration-300 bg-zinc-900 hover:border-red-600 hover:text-red-600">
        ...
        <Link href="https://discord.gg/sickkservices" target="_blank" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-purple-600 rounded border border-purple-900 transition duration-300 bg-zinc-900 hover:border-red-600 hover:text-red-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            <path d="M19.5 7a9 9 0 0 0 -7.5 -4a8.991 8.991 0 0 0 -7.484 4"></path>
            <path d="M11.5 3a16.989 16.989 0 0 0 -1.826 4"></path>
      ...
      <p className="max-w-lg p-4 text-sm border rounded-lg md:text-base border-white/20 bg-gray-500/10">
        Easy and affordable permanent spoofer. Trusted by many.
      </p>
    </section>
  )
}
    ...
    <section className="flex flex-col items-center justify-center p-4">
      <div className="mb-5 space-y-1.5 max-w-lg">
        <p className="block px-3 py-1.5 text-sm font-bold rounded-lg border transition duration-300 border-amber-300/30 bg-amber-300/10 hover:bg-amber-300/20 hover:border-amber-100/50">
          Please ensure that you verify their status prior to making a purchase. Our statement regarding itstrustworthiness and undetectability does not imply that it is current or up to date, <Link href="https://discord.gg/sickkservices" className="underline">discord.gg/sickkservices</Link>
        </p>
      </div>
