    ...
    <section className="flex flex-col items-center justify-center p-2 my-4 mt-8 mb-2 space-y-4 font-bold text-md md:text-md">
      <div className="flex items-center justify-center space-x-4">
        <Image 
          ...
          src="/assets/chaos.webp"
          alt=""
          width={56}
          height={56}
        />
        <span className="flex items-center justify-center capitalize">
          <span className="text-xl font-bold md:text-2xl">Chaos</span>
        </span>
      </div>
      
      <div className="flex flex-wrap items-center justify-center space-x-2">
        <Link href="https://discord.gg/chaosfn" target="_blank" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-gray-300 rounded border border-gray-600 transition duration-300 bg-zinc-900 hover:border-lime-600 hover:text-lime-600">
        ...
        <Link href="https://discord.gg/chaosfn" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-orange-600 rounded border border-orange-900 transition duration-300 bg-zinc-900 hover:border-lime-600 hover:text-lime-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            <path d="M19.5 7a9 9 0 0 0 -7.5 -4a8.991 8.991 0 0 0 -7.484 4"></path>
            <path d="M11.5 3a16.989 16.989 0 0 0 -1.826 4"></path>
      ...
      Application based, and secure cheat. Popular and well-regarded.
      </p>
    </section>
  )
}
    ...
    <section className="flex flex-col items-center justify-center p-4">
      <div className="mb-5 space-y-1.5 max-w-lg">
        <p className="block px-3 py-1.5 text-sm font-bold rounded-lg border transition duration-300 border-amber-300/30 bg-amber-300/10 hover:bg-amber-300/20 hover:border-amber-100/50">
          ...
          trustworthiness and undetectability does not imply that it is current or up to date, <Link href="https://discord.gg/chaosfn" className="underline">discord.gg/chaos</Link>
        </p>
      </div>
      
      <div className="grid grid-cols-1 gap-2 mt-2 auto-cols-max md:grid-cols-2">
        {['Dashboard via a Web Panel', 'Advanced USB loader', 'Ultimate gaming optimization', 'Disguises hardware fingerprints '].map((feature, index) => (
