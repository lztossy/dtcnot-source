...
export default function SyncPage() {
  ...
  const handleSearch = (filters: SearchFilters) => {
    if (filters.provider.toLowerCase() === 'sync.top' || filters.game.toLowerCase() === 'valorant') {
      setSearchResults({ provider: 'Sync.top', game: 'VALORANT' })
    } else {
    ...
    <section className="flex flex-col items-center justify-center p-2 my-4 mt-8 mb-2 space-y-4 font-bold text-md md:text-md">
      <div className="flex items-center justify-center space-x-4">
        <Image 
          ...
          src="https://cdn.discordapp.com/icons/1115767018214412408/20f29b71216e99fe3f01e339cd66890a.webp"
          alt=""
          width={56}
          height={56}
        />
        <span className="flex items-center justify-center capitalize">
          <span className="text-xl font-bold md:text-2xl">Sync.top</span>
        </span>
      </div>
      
      <div className="flex flex-wrap items-center justify-center space-x-2">
        <Link href="https://sync.top/" target="_blank" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-gray-300 rounded border border-gray-600 transition duration-300 bg-zinc-900 hover:border-red-600 hover:text-red-600">
        ...
        <Link href="https://sync.top/discord" target="_blank" className="flex justify-center items-center px-2 py-1 space-x-1 text-center text-purple-600 rounded border border-purple-900 transition duration-300 bg-zinc-900 hover:border-red-600 hover:text-red-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            <path d="M19.5 7a9 9 0 0 0 -7.5 -4a8.991 8.991 0 0 0 -7.484 4"></path>
            <path d="M11.5 3a16.989 16.989 0 0 0 -1.826 4"></path>
        ...
        <Link href="#" className={`flex justify-center items-center px-2 py-1 space-x-1 text-center rounded border border-yellow-900 transition duration-300 bg-zinc-900 hover:border-red-600 hover:text-red-600 ${gameColors['VALORANT']}`}>
      ...
      <p className="max-w-lg p-4 text-sm border rounded-lg md:text-base border-white/20 bg-gray-500/10">
        Easy and affordable temporary spoofer. Trusted by many.
      </p>
    </section>
  )
}
    ...
    <section className="flex flex-col items-center justify-center p-4">
      <div className="mb-5 space-y-1.5 max-w-lg">
        <p className="block px-3 py-1.5 text-sm font-bold rounded-lg border transition duration-300 border-amber-300/30 bg-amber-300/10 hover:bg-amber-300/20 hover:border-amber-100/50">
          Please ensure that you verify their status prior to making a purchase. Our statement regarding itstrustworthiness and undetectability does not imply that it is current or up to date, <Link href="https://sync.top/discord" className="underline">discord.gg/sync</Link>
        </p>
      </div>
